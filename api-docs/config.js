// List of specifications shown in the selector (top bar).
// url may be absolute (the server must allow CORS) or relative to this page.
window.SWAGGER_SPECS = [
  { name: "Fabix API", url: "../openapi.yaml" },
  { name: "Лаб.контроль", url: "../labcontrol.yaml" },
  { name: "План выпуска ГП", url: "../plan.yaml" }
